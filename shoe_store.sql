...
CREATE TABLE `shoe_customer` (
  ...
  `date_of_birth` date NOT NULL DEFAULT '2010-01-01',
...
('AAAA', 500000, '2023-10-28 22:05:00'),
...
--
-- Đang đổ dữ liệu cho bảng `shoe_discount_customer`
--

INSERT INTO `shoe_discount_customer` (`id`, `customer_id`, `discount_code`) VALUES
(1, 1, 'GIAM50K');
...
(5, 3, 'Đơn hàng của bạn đã có cập nhật', 'Đơn hàng có mã là: 8 đã có cập nhật mới', '2023-10-23 09:15:19'),
(6, 3, 'Đơn hàng của bạn đã có cập nhật', 'Đơn hàng có mã là: 6 đã có cập nhật mới', '2023-10-23 13:07:12'),
(7, 3, 'Đơn hàng của bạn đã có cập nhật', 'Đơn hàng có mã là: 6 đã có cập nhật mới', '2023-10-23 13:07:27');
...
(8, 3, '2023-10-23 16:02:06', 5950000, 5, 10, 'Thanh toán khi nhận hàng', 'Hoằng Quỳ, Hoằng Hóa, Thanh Hóa', NULL);
